        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstadoMovimiento = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    CajaId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorNombre = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    TalleId = table.Column<int>(type: "int", nullable: true),
                    TalleNombre = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Estado = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
